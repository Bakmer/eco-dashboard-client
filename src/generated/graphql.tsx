...
export type ClientFragment = { __typename?: "Client" } & Pick<
  Client,
  "id" | "name" | "last_name" | "email" | "memo"
> & {
    store: { __typename?: "Store" } & Pick<Store, "id" | "name">;
    state: { __typename?: "State" } & Pick<State, "id" | "name">;
    discount: { __typename?: "Discount" } & Pick<Discount, "id" | "percentage">;
    phones: Array<{ __typename?: "Phone" } & ClientPhoneFragment>;
    billings: Array<{ __typename?: "Billing" } & ClientBillingFragment>;
    shippings: Array<{ __typename?: "Shipping" } & ClientShippingFragment>;
    addresses: Array<{ __typename?: "Address" } & ClientAddressFragment>;
  };

export type ClientAddressFragment = { __typename?: "Address" } & Pick<
  Address,
  "id" | "name" | "street" | "street_number" | "memo" | "province" | "location" | "postal_code"
>;

export type ClientBillingFragment = { __typename?: "Billing" } & Pick<
  Billing,
  "id" | "name" | "street" | "street_number" | "memo" | "cuit" | "province" | "location" | "postal_code"
> & { iva: { __typename?: "Iva" } & Pick<Iva, "id" | "name"> };

export type ClientPhoneFragment = { __typename?: "Phone" } & Pick<Phone, "id" | "name" | "area_code" | "phone">;

export type ClientShippingFragment = { __typename?: "Shipping" } & Pick<
  Shipping,
  "id" | "name" | "street" | "street_number" | "memo" | "cuit" | "province" | "location" | "postal_code"
> & { transport: { __typename?: "Transport" } & Pick<Transport, "id" | "name"> };

export type ChangeClientStateMutationVariables = Exact<{
  id: Scalars["Float"];
}>;

export type ChangeClientStateMutation = { __typename?: "Mutation" } & {
  changeClientState: { __typename?: "ClientResponse" } & Pick<ClientResponse, "message"> & {
      data?: Maybe<{ __typename?: "Client" } & Pick<Client, "created_at"> & ClientFragment>;
    };
};
...
export type CreateClientMutation = { __typename?: "Mutation" } & {
  createClient: { __typename?: "ClientResponse" } & Pick<ClientResponse, "message"> & {
      data?: Maybe<{ __typename?: "Client" } & ClientFragment>;
    };
};
...
export type CreatePhoneMutation = { __typename?: "Mutation" } & {
  createPhone: { __typename?: "PhoneResponse" } & Pick<PhoneResponse, "message"> & {
      data?: Maybe<{ __typename?: "Phone" } & ClientPhoneFragment>;
    };
};
...
export type UpdateClientMutation = { __typename?: "Mutation" } & {
  updateClient: { __typename?: "ClientResponse" } & Pick<ClientResponse, "message"> & {
      data?: Maybe<{ __typename?: "Client" } & ClientFragment>;
    };
};
...
export type GetClientQuery = { __typename?: "Query" } & {
  getClient: { __typename?: "ClientResponse" } & { data?: Maybe<{ __typename?: "Client" } & ClientFragment> };
};
...
export type ListClientsQuery = { __typename?: "Query" } & {
  listClients: { __typename?: "PaginatedClientsResponse" } & Pick<PaginatedClientsResponse, "message"> & {
      data?: Maybe<
        Array<
          { __typename?: "Client" } & Pick<Client, "id" | "name" | "last_name" | "email" | "memo" | "created_at"> & {
              store: { __typename?: "Store" } & Pick<Store, "id" | "name">;
              state: { __typename?: "State" } & Pick<State, "id" | "name">;
              discount: { __typename?: "Discount" } & Pick<Discount, "id" | "percentage">;
              phones: Array<{ __typename?: "Phone" } & Pick<Phone, "id" | "name" | "area_code" | "phone">>;
              shippings: Array<
                { __typename?: "Shipping" } & Pick<
                  Shipping,
                  "id" | "name" | "street" | "street_number" | "cuit" | "province" | "location" | "postal_code" | "memo"
                > & { transport: { __typename?: "Transport" } & Pick<Transport, "id" | "name"> }
              >;
            }
        >
      >;
      filters?: Maybe<
        { __typename?: "PaginationFilters" } & Pick<
          PaginationFilters,
          "search" | "page" | "per_page" | "order_by" | "order_type" | "count"
        >
      >;
    };
};
...
export type ListDiscountsQuery = { __typename?: "Query" } & {
  listDiscounts: { __typename?: "ListDiscountResponse" } & Pick<ListDiscountResponse, "message"> & {
      data?: Maybe<Array<{ __typename?: "Discount" } & Pick<Discount, "id" | "percentage">>>;
    };
};
...
export type ListRolesQuery = { __typename?: "Query" } & {
  listRoles: { __typename?: "ListRolesResponse" } & Pick<ListRolesResponse, "message"> & {
      data?: Maybe<Array<{ __typename?: "Role" } & Pick<Role, "id" | "name">>>;
    };
};

export type ListStatesQueryVariables = Exact<{ [key: string]: never }>;

export type ListStatesQuery = { __typename?: "Query" } & {
  listStates: { __typename?: "ListStatesResponse" } & Pick<ListStatesResponse, "message"> & {
      data?: Maybe<Array<{ __typename?: "State" } & Pick<State, "id" | "name">>>;
    };
};
...
export type ListStoresQuery = { __typename?: "Query" } & {
  listStores: { __typename?: "ListStoresResponse" } & Pick<ListStoresResponse, "message"> & {
      data?: Maybe<Array<{ __typename?: "Store" } & Pick<Store, "id" | "name">>>;
    };
};
...
export type ChangeUserStateMutation = { __typename?: "Mutation" } & {
  changeUserState: { __typename?: "UserResponse" } & Pick<UserResponse, "message"> & {
      data?: Maybe<{ __typename?: "User" } & UserFragment>;
    };
};
...
export type CreateUserMutation = { __typename?: "Mutation" } & {
  createUser: { __typename?: "UserResponse" } & Pick<UserResponse, "message"> & {
      data?: Maybe<{ __typename?: "User" } & Pick<User, "username" | "name" | "last_name">>;
    };
};
...
export type DeleteUserMutation = { __typename?: "Mutation" } & {
  deleteUser: { __typename?: "ApiResponse" } & Pick<ApiResponse, "data" | "message">;
};
...
export type LoginMutation = { __typename?: "Mutation" } & {
  login: { __typename?: "UserResponse" } & Pick<UserResponse, "message"> & {
      data?: Maybe<{ __typename?: "User" } & UserFragment>;
    };
};
...
export type LogoutMutation = { __typename?: "Mutation" } & {
  logout: { __typename?: "UserResponse" } & Pick<UserResponse, "message">;
};
...
export type UpdateUserMutation = { __typename?: "Mutation" } & {
  updateUser: { __typename?: "UserResponse" } & Pick<UserResponse, "message"> & {
      data?: Maybe<{ __typename?: "User" } & UserFragment>;
    };
};
...
export type ListUsersQuery = { __typename?: "Query" } & {
  listUsers: { __typename?: "PaginatedUsersResponse" } & Pick<PaginatedUsersResponse, "message"> & {
      data?: Maybe<Array<{ __typename?: "User" } & UserFragment>>;
      filters?: Maybe<
        { __typename?: "PaginationFilters" } & Pick<
          PaginationFilters,
          "search" | "page" | "per_page" | "order_by" | "order_type" | "count"
...
export type MeQuery = { __typename?: "Query" } & {
  me: { __typename?: "UserResponse" } & Pick<UserResponse, "message"> & {
      data?: Maybe<{ __typename?: "User" } & UserFragment>;
    };
};
...
export const ChangeClientStateDocument = gql`
  ...
  ${ClientFragmentDoc}
`;
export type ChangeClientStateMutationFn = Apollo.MutationFunction<
  ChangeClientStateMutation,
  ChangeClientStateMutationVariables
>;
 ...
 * });
 */
export function useChangeClientStateMutation(
  baseOptions?: Apollo.MutationHookOptions<ChangeClientStateMutation, ChangeClientStateMutationVariables>
) {
  return Apollo.useMutation<ChangeClientStateMutation, ChangeClientStateMutationVariables>(
    ChangeClientStateDocument,
    baseOptions
  );
}
...
export type ChangeClientStateMutationOptions = Apollo.BaseMutationOptions<
  ChangeClientStateMutation,
  ChangeClientStateMutationVariables
>;
...
export const CreatePhoneDocument = gql`
  mutation CreatePhone($name: String!, $client_id: Float!, $area_code: Float!, $phone: Float!) {
    createPhone(data: { name: $name, client_id: $client_id, area_code: $area_code, phone: $phone }) {
      data {
        ...ClientPhone
      }
      message
 ...
 * });
 */
export function useListDiscountsQuery(
  baseOptions?: Apollo.QueryHookOptions<ListDiscountsQuery, ListDiscountsQueryVariables>
) {
  return Apollo.useQuery<ListDiscountsQuery, ListDiscountsQueryVariables>(ListDiscountsDocument, baseOptions);
}
export function useListDiscountsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ListDiscountsQuery, ListDiscountsQueryVariables>
) {
...
export function useListStatesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ListStatesQuery, ListStatesQueryVariables>
) {
...
export function useListStoresLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ListStoresQuery, ListStoresQueryVariables>
) {
...
export const ChangeUserStateDocument = gql`
  ...
  ${UserFragmentDoc}
`;
export type ChangeUserStateMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useChangeUserStateMutation(
  baseOptions?: Apollo.MutationHookOptions<ChangeUserStateMutation, ChangeUserStateMutationVariables>
) {
  return Apollo.useMutation<ChangeUserStateMutation, ChangeUserStateMutationVariables>(
    ChangeUserStateDocument,
    baseOptions
  );
}
...
export type ChangeUserStateMutationOptions = Apollo.BaseMutationOptions<
  ChangeUserStateMutation,
  ChangeUserStateMutationVariables
>;
